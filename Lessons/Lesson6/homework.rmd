...
model1a <- glm(data = train,
              ...
              family = Gamma())
summary(model1a)
mse(predict(model1a, train, type = "response"), train$Burning_Cost) #vyslo mse medzi predikciou train. a skutocnou train. = 198 
