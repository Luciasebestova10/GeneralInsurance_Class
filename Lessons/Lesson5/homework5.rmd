...
dt_pol_w_claims %>% 
  ...
  arrange(desc(BC_avg)) %>% head() 
```
Vychádza, ze podla priemeru Burning Cost je najrizikovejsi rok 1997, ale poistiek, pri ktorych vozidlo bolo vyrobene v tom roku bolo iba 30 a narozdiel od inych rokov kde priemer BC je o trochu mensi ale je omnoho viac uzavretych poistiek s tymi rokmi vyrobi. Preto som sa pozrela ake roky budu na prvych siestych miestach ak to zoradim  podla poctu uzavretych zmluv.
